...
/** 此处后端没有提供注释 POST /user/create */
export async function create(body: API.UserCreateRequest, options?: { [key: string]: any }) {
...
export async function getVoById(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getVOByIdParams,
  options?: { [key: string]: any }
) {
  const { id: param0, ...queryParams } = params
  return request<API.BaseResponseLoginUserVO>(`/user/get/vo/${param0}`, {
    method: 'GET',
    params: { ...queryParams },
    ...(options || {}),
  })
...
/** 此处后端没有提供注释 PUT /user/update/my */
export async function updateMy(body: API.UserUpdateMyRequest, options?: { [key: string]: any }) {
